                                      ...
                                      SystemLocation &newLocation)
{
    ...
    newLocation = myDirectionIndex.perFormDirectionByEndBar(
        currentLocation,
        active_repeat ? active_repeat->getCurrentRepeatNumber() : 1);
...
void
RepeatController::checkForSegnoMark(const SystemLocation &currentLocation)
{
    RepeatedSection *active_repeat = myRepeatIndex.findRepeat(currentLocation);
    myDirectionIndex.checkSegnoMark(
        currentLocation,
        active_repeat ? active_repeat->getCurrentRepeatNumber() : 1);
}

...
const Barline *System::getNextBarline(int position) const
{
    ...
    if (myBarlines.size()>0)
    {
        return &myBarlines[myBarlines.size()-1];
    }
...
Barline *System::getNextBarline(int position)
{
    ...
    if (myBarlines.size() > position+1 && position+1>=0)
    {
        return &myBarlines[position+1];
    }
    return nullptr;
}
...
//
//std::vector<std::vector<TextItem>> &
//System::staffLyrics()
//{
//    return myStaffLyrics;
//}
//
//
//const std::vector<std::vector<TextItem>> &
//System::staffLyrics() const
//{
//    return myStaffLyrics;
//}

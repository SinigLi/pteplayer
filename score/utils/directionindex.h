...
public:
    ...
    SystemLocation performDirection(const SystemLocation &prevLocation,
                                    ...
                                    int activeRepeat);
    void checkSegnoMark(const SystemLocation &currentLocation,int activeRepeat);
    SystemLocation perFormDirectionByEndBar(
        const SystemLocation &currentLocation,int activeRepeat);
...
private:
    ...
    bool myIsNeedSeg = false;
    bool myIsNeedSegSeg = false;
    DirectionSymbol::SymbolType mNeedSegCanDeSymbol = DirectionSymbol::SymbolType::S_None;

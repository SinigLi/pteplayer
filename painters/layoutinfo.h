...
struct LayoutInfo
{
    LayoutInfo(const ConstScoreLocation &location, const ViewOptions *viewOpt=nullptr);
    void setViewOpts(const ViewOptions *viewOpt);
    int getStringCount() const;

    double getSystemSymbolSpacing() const;
    double getStaffHeight() const;
    double getTabStemExtraBeamHeight(bool containStem=true)const;
    ...
    static const double SYSTEM_PER_CHORD_DIAGRAM_SPACING;
    ...
    bool isShowTabStuff() const;
    bool isShowStdStuff() const;
...
private:
    ...
    const ViewOptions *mViewOpt = nullptr;
